...
function App() {
  ...
  return (
    <div className=' flex flex-col w-screen  overflow-y-scroll '>
      ...
      <div className=' absolute flex justify-center w-[5%] '><i className="ri-twitter-x-line p-3 text-white text-2xl sm:fixed  bg-black sm:z-30 sm:flex  sm:items-center sm:justify-center sm:text-3xl sm:overflow-hidden sm:border-r-[0.5px]  sm:border-gray-700 sm:w-[10vw] sm:h-[10vh]"></i>
      </div>
        ...
        <div className='w-full'>
          <img className='flex justify-start  h-9 w-9 mt-3 object-cover rounded-full' src="https://thumbs.dreamstime.com/b/profile-picture-caucasian-male-employee-posing-office-happy-young-worker-look-camera-workplace-headshot-portrait-smiling-190186649.jpg" alt="" />
        </div>
      </div>


      <div className="w-full fixed  bottom-0  flex  items-end justify-around gap-5 z-10 bg-black p-2
    sm:items-center sm:h-[95%] sm:flex-col sm:justify-start sm:gap-6 sm:z-10 sm:top-14 sm:mt-2
     sm:border-r-[0.5px] sm:border-gray-700 sm:w-[10vw] sm:fixed">
      ...
      <div className='relative flex top-[2vh] overflow-x-auto p-4 justify-around scrollbar-none w-full whitespace-nowrap text-base font-medium gap-6 text-gray-400 border-b-[0.5px] border-gray-700 sm:flex sm:left-[10vw]
    sm:top-0  sm:overflow-x-auto sm:whitespace-nowrap sm:gap-7 sm:w-full sm:z-10 sm:bg-black sm:fixed sm:p-4'
      ...
      <div className='relative mb-16 sm:w-[90vw] z-0  pb-2 sm:left-[10vw]  sm:h-[90vh] sm:mb-16 sm:flex sm:flex-col  '>

<div className='relative top-[2vh]  border-b-[0.5px] border-gray-700 '>
  <div className='flex flex-row align-middle border-gray-700 '>
    <div className=''>
...
<div className='relative top-[2vh] h-30vh border-b-[0.5px] border-gray-700'>
  <div className='flex flex-row align-middle'>
    <div className=''>
